          ...
          <div className="rectangle-wrapper" style={{ paddingBottom: "200px" }}>
            <div className="consiliereSection">
              ...
              <div className="consiliereText">
                <h1>
                  Consilierea prin e-mail se adresează persoanelor care nu
                  doresc sau nu au acces la o formă de intervenţie psihologică
                  sau psihoterapeutică directă;
                </h1>
                <h4>
                  Consilierea vă poate ajuta să depăşiţi o dificultate, să
                  ieşiţi dintr-o criză <br />
                  sau să vă clarificaţi o problemă care vă preocupă.
                </h4>
              </div>
            </div>
            <div className="consiliereSection">
              <div className="consiliereIconMobile">
                <img
              ...
              <div>
                ...
                <p>
                  În cazul în care aveţi probleme grave de sănătate mentală, vă
                  rugăm să vă adresaţi medicului de familie sau unui cabinet
                  medical / psihologic specializat.
                </p>
              </div>
            ...
            <div className="consiliereSection">
              ...
              <div>
                ...
                <ul>
                  <li>
                    Datele dvs. de identificare: numele, prenumele, adresa, nr.
                    telefon, vârsta;
                  </li>
                ...
                <p>
                  În cel mult 2 zile lucrătoare, unul dintre consilierii noştri
                  va analiza solicitarea dvs. şi vă va trimite un e-mail de
                  răspuns;
                </p>
                <p>
                ...
                <p>
                  Primiti confirmare a recepţionării plăţii, iar consilierea va
                  începe de comun acord prin serviciul de email sau de skype.
                </p>
              </div>
              <div className="consiliereIcon">
                <img
            ...
            <div className="consiliereSection">
              ...
              <div>
                ...
                <p>
                  Serviciul de consiliere constă într-un schimb de 5 e-mail-uri;
                  un e-mail trimis de dvs. va avea maximum 4 pagini ;
                </p>
                <p>
